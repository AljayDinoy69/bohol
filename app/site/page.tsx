...
import { MapPin, Search, Plus, Edit, Trash2, Activity } from "lucide-react";
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {filtered.length > 0 ? (
                  filtered.map((site, index) => (
                    <div key={`${site.id}-${site.name?.replace(/\s+/g, '-') || 'unknown'}-${index}`} className="rounded-xl border border-white/10 bg-black/30 p-4">
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-white/80">{site.lastCheck}</span>
                        </div>
                      </div>
                      <div className="flex items-center gap-2 pt-2 border-t border-white/10 -mx-4 -mb-4 px-4 pb-4">
                        <button 
